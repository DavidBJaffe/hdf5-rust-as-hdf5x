...
#[cfg(test)]
pub mod tests {
    use hdf5x_sys::h5p::{H5Pclose, H5Pcreate};
    ...
    pub fn test_error_stack() {
        ...
        let stack = match stack {
            ...
            Error::Internal(internal) => panic!("Expected hdf5x error, not {}", internal),
        }
        .expand()
        .unwrap();
