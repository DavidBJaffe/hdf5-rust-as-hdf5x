...
use hdf5x_sys::h5c::{H5C_cache_decr_mode, H5C_cache_flash_incr_mode, H5C_cache_incr_mode};
use hdf5x_sys::h5f::{H5F_close_degree_t, H5F_mem_t, H5F_FAMILY_DEFAULT};
use hdf5x_sys::h5fd::H5FD_MEM_NTYPES;
use hdf5x_sys::h5fd::{
...
use hdf5x_sys::h5p::{H5Pget_fapl_direct, H5Pset_fapl_direct};
#[cfg(feature = "mpio")]
use hdf5x_sys::h5p::{H5Pget_fapl_mpio, H5Pset_fapl_mpio};

#[cfg(feature = "1.10.1")]
use hdf5x_sys::h5ac::{H5AC_cache_image_config_t, H5AC__CACHE_IMAGE__ENTRY_AGEOUT__NONE};
#[cfg(feature = "1.10.2")]
use hdf5x_sys::h5f::H5F_libver_t;
...
#[cfg(feature = "1.8.13")]
use hdf5x_sys::h5p::{H5Pget_core_write_tracking, H5Pset_core_write_tracking};
#[cfg(feature = "1.8.7")]
use hdf5x_sys::h5p::{H5Pget_elink_file_cache_size, H5Pset_elink_file_cache_size};
#[cfg(feature = "1.10.1")]
use hdf5x_sys::h5p::{
...
#[cfg(feature = "1.10.2")]
use hdf5x_sys::h5p::{H5Pget_libver_bounds, H5Pset_libver_bounds};
#[cfg(feature = "1.10.0")]
use hdf5x_sys::h5p::{
