...
use hdf5x_sys::h5p::{H5Pcreate, H5Pget_chunk_cache, H5Pset_chunk_cache};
#[cfg(all(feature = "1.10.0", feature = "have-parallel"))]
use hdf5x_sys::h5p::{H5Pget_all_coll_metadata_ops, H5Pset_all_coll_metadata_ops};
#[cfg(feature = "1.8.17")]
use hdf5x_sys::h5p::{H5Pget_efile_prefix, H5Pset_efile_prefix};
#[cfg(feature = "1.10.0")]
use hdf5x_sys::{
    h5d::H5D_vds_view_t,
    h5p::{
